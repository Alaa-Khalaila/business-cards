        ...
        <div className={styles.all + " container" } dir="ltr">
            ...
            <form dir="rtl">
                <div>
                    ...
                    <input onKeyUp={nameHandler} defaultValue={name} id="firstNum" type="text"  />
                </div>
                <div>
                    <label htmlFor="firstNum">الرقم الاول:</label>
                    <input onKeyUp={firstNumHandler} defaultValue={firstNum} id="firstNum" type="text"  />
                </div>
                <div>
                    <label htmlFor="secondNum">الرقم الثاني:</label>
                    <input defaultValue={secondNum} type="text" onKeyUp={secondNumHandler} />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input defaultValue={location} type="text" onKeyUp={locationHandler} />
                </div>
                <div>
                ...
                <div>ملاحظة: سيتم ارسال رمز خاص لكل بطاقة للدخول على السحب, ضاعف فرصة ربحك للسيارة بشراء اكثر من بطاقة</div>
                <NavLink to="/" className="mt-2">
                <Button classList={styles.add + " yellow"} text="اضف الى السلة" onClick={()=>addToCart(counter)}></Button>
                </NavLink>
