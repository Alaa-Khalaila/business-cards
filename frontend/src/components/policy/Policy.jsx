      ...
      <div className={styles.cont}>
        <section className="container" dir="ltr">
          ...
          <div>
            ...
            terms.<br /><br /> Information we collect The personal information that you are
            ...
            send us, and any other information you may choose to provide. When
            you register for an Account, we may ask for your contact
            information, including items such as name, company name, address,
            email address, and telephone number.<br /><br /> How we use your information We
            use the information we collect in various ways, including to:
            ...
            of personal data that a business has collected about consumers.<br /><br />
